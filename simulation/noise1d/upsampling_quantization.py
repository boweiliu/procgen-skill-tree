...
def main():
    ...
    #plot_helper(apply_harddither(gaussian_azure, ditherer=gaussian_brown))
    #plot_helper(apply_harddither(gaussian_azure, ditherer=gaussian_pink))
    #plot_helper(apply_harddither(gaussian_azure, ditherer=gaussian_white))
    plot_helper(apply_harddither(gaussian_azure, ditherer=gaussian_azure))
    plot_helper(apply_harddither(gaussian_azure, ditherer=gaussian_violet))
    plot_helper(apply_harddither(gaussian_azure, ditherer=gaussian_azure, dither_scale = 1.0 ))
    plot_helper(apply_harddither(gaussian_azure, ditherer=gaussian_violet, dither_scale = 1.0 ))
    plot_helper(apply_harddither(gaussian_azure, ditherer=gaussian_azure, dither_scale = 0.25 ))
    plot_helper(apply_harddither(gaussian_azure, ditherer=gaussian_violet, dither_scale = 0.25 ))
    #plot_helper(apply_harddither(gaussian_azure, ditherer=gaussian_ultraviolet))
    #plot_helper(apply_harddither(gaussian_pink_warm, ditherer=gaussian_brown))
    #plot_helper(apply_harddither(gaussian_pink_warm, ditherer=gaussian_pink))
    #plot_helper(apply_harddither(gaussian_pink_warm, ditherer=gaussian_white))
    #plot_helper(apply_harddither(gaussian_pink_warm, ditherer=gaussian_azure))
    #plot_helper(apply_harddither(gaussian_pink_warm, ditherer=gaussian_violet))
    #plot_helper(apply_harddither(gaussian_pink_warm, ditherer=gaussian_ultraviolet))
